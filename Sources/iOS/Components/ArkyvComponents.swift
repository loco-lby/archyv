...
// FolderSelectionRow also now lives in ArkyvKit (Design/FolderSelectionRow.swift,
// moved there during Share Extension Visual Consistency 01) for the same reason.
